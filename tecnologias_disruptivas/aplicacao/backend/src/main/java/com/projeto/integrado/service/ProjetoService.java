...
public class ProjetoService {
	...
	public Projeto getByRecursoNome(Integer recursoNome) {
		return projetoRepository.findByRecursoNome(recursoNome).orElse(null);
	}

	public Projeto getByProjetoDescricao(Integer projetoDescricao) {
		return projetoRepository.findByProjetoDescricao(projetoDescricao).orElse(null);
	}

	public Projeto getByStatus(Integer status) {
		return projetoRepository.findByStatus(status).orElse(null);
	}
